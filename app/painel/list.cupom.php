...
$sql_total = "SELECT COUNT(*) AS total FROM cupom WHERE id_empresa = ".$_COOKIE['authorization_id'];
...
$sql_query = $mysqli->query($sql_code) or die("Falha na execução do código SQL: " . $mysqli->error);
$cupom = $sql_query->fetch_all(MYSQLI_ASSOC);
...
<body>
    <div class="b-main-container-topo b-main-shadow-topo">
        ...
        <div class="cart b-main-centro-total"><i onclick="addCupom('0')" class='bx bx-plus'></i></div>
    </div>
                      ...
                      <tr>
                        ...
                        <td style="width: 100px;">
                          <div style="width: 40px; position: relative; float: right;" class="b-main-container-right b-main-centro-total">
                            <div class="buttons-bt-generic-2-table b-main-centro-total"><a href="#" onclick="addCupom('<?php echo $row['id']; ?>')"><i class='bx bx-edit'></i></a></div>
                          </div>
                        </td>
                      </tr>
                      <?php }; ?>
    ...
    <div style="height: 60px;" class="b-main-container-footer b-main-active-mobile-footer-bar">
      <div class="b-main-item-menu-footer-mobile b-main-centro-total"><i onclick="openPageMenuMobile('list.pedidos.php')" class='bx bx-cart disabled'></i></div>
